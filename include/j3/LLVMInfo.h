...
class LLVMClassInfo : public vmkit::JITInfo {
...
class LLVMMethodInfo : public vmkit::JITInfo {
private:
...
class LLVMFieldInfo : public vmkit::JITInfo {
private:
...
class LLVMSignatureInfo : public vmkit::JITInfo {
private:
